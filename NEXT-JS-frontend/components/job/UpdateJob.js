...
const UpdateJob = ({ job, access_token }) => {
  ...
  const [diversityGroup, setDiversityGroup] = useState("Women");
  ...
  useEffect(() => {
    if (job) {
      ...
      setDiversityGroup(job.diversityGroup);
        ...
        <form className="form" onSubmit={submitHandler}>
          <div className="row">
            ...
            <div className="col-12 col-md-6 ml-4 mt-4 mt-md-0 ml-md-0">
              ...
              <div className="boxWrapper">
                <h4>Diversity Group:</h4>
                <div className="selectWrapper">
                  <select
                    className="classic"
                    value={diversityGroup}
                    onChange={(e) => setDiversityGroup(e.target.value)}
                  >
                    {diversityGroupOptions.map((option) => (
                      <option key={option} value={option}>
                        {option}
                      </option>
                    ))}
